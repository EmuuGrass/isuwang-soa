...
public class SoaSystemEnvProperties {
    ...
    private static final String KEY_SOA_APIDOC_ENABLE = "soa.apidoc.enable";
    ...
    public static final boolean SOA_APIDOC_ENABLE = Boolean.valueOf(get(KEY_SOA_APIDOC_ENABLE,"true"));
